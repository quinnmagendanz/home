...
bash_prompt() {
    ...
    [ $UID -eq "0" ] && UC=$Y   # root's color
  
    PS1="$TITLEBAR ${EMK}${UC}\u${EMK}@${EMM}\h${EMK}:${EMY}\${NEW_PWD}${EMK} ${EMY}\\$ ${NONE}"
...
#alias ls='ls --color'
#LS_COLORS='di=36:fi=92:ln=35:pi=31:so=31:bd=5:cd=5:or=31:mi=0:ex=92:*.rpm=90'
#export LS_COLORS
